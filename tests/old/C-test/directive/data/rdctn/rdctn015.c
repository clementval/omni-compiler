 ...
 */
/* reduction 015 :
 * long 変数に reduction が指定された場合の動作確認
 */
...
long	rdct_inc, rdct_inc2, rdct_pls, rdct_pls2, rdct_pls3;
long	rdct_dec, rdct_dec2, rdct_mns, rdct_mns2;
long	rdct_mul, rdct_mul2, rdct_mul3;
long	rdct_land, rdct_land2, rdct_land3;
long	rdct_lor, rdct_lor2, rdct_lor3;
long	rdct_xor, rdct_xor2, rdct_xor3;
long	rdct_and, rdct_and2;
long	rdct_or, rdct_or2;

long	rst_inc, rst_inc2, rst_pls, rst_pls2, rst_pls3;
long	rst_dec, rst_dec2, rst_mns, rst_mns2;
long	rst_mul, rst_mul2, rst_mul3;
long	rst_land, rst_land2, rst_land3;
long	rst_lor, rst_lor2, rst_lor3;
long	rst_xor, rst_xor2, rst_xor3;
long	rst_and, rst_and2;
long	rst_or, rst_or2;
...
main ()
{
  ...
  for (i=0; i<LOOPNUM; i++) {
    ...
    if (sizeof(rdct_inc) != sizeof(long)) {
      #pragma omp critical
      errors += 1;
    }
    if (sizeof(rdct_inc2) != sizeof(long)) {
      #pragma omp critical
      errors += 1;
    }
    if (sizeof(rdct_pls) != sizeof(long)) {
      #pragma omp critical
      errors += 1;
    }
    if (sizeof(rdct_pls2) != sizeof(long)) {
      #pragma omp critical
      errors += 1;
    }
    if (sizeof(rdct_pls3) != sizeof(long)) {
      #pragma omp critical
      errors += 1;
    }
    if (sizeof(rdct_dec) != sizeof(long)) {
      #pragma omp critical
      errors += 1;
    }
    if (sizeof(rdct_dec2) != sizeof(long)) {
      #pragma omp critical
      errors += 1;
    }
    if (sizeof(rdct_mns) != sizeof(long)) {
      #pragma omp critical
      errors += 1;
    }
    if (sizeof(rdct_mns2) != sizeof(long)) {
      #pragma omp critical
      errors += 1;
    }
    if (sizeof(rdct_mul) != sizeof(long)) {
      #pragma omp critical
      errors += 1;
    }
    if (sizeof(rdct_mul2) != sizeof(long)) {
      #pragma omp critical
      errors += 1;
    }
    if (sizeof(rdct_mul3) != sizeof(long)) {
      #pragma omp critical
      errors += 1;
    }
    if (sizeof(rdct_land) != sizeof(long)) {
      #pragma omp critical
      errors += 1;
    }
    if (sizeof(rdct_land2) != sizeof(long)) {
      #pragma omp critical
      errors += 1;
    }
    if (sizeof(rdct_land3) != sizeof(long)) {
      #pragma omp critical
      errors += 1;
    }
    if (sizeof(rdct_lor) != sizeof(long)) {
      #pragma omp critical
      errors += 1;
    }
    if (sizeof(rdct_lor2) != sizeof(long)) {
      #pragma omp critical
      errors += 1;
    }
    if (sizeof(rdct_lor3) != sizeof(long)) {
      #pragma omp critical
      errors += 1;
    }
    if (sizeof(rdct_xor) != sizeof(long)) {
      #pragma omp critical
      errors += 1;
    }
    if (sizeof(rdct_xor2) != sizeof(long)) {
      #pragma omp critical
      errors += 1;
    }
    if (sizeof(rdct_xor3) != sizeof(long)) {
      #pragma omp critical
      errors += 1;
    }
    if (sizeof(rdct_and) != sizeof(long)) {
      #pragma omp critical
      errors += 1;
    }
    if (sizeof(rdct_and2) != sizeof(long)) {
      #pragma omp critical
      errors += 1;
    }
    if (sizeof(rdct_or) != sizeof(long)) {
      #pragma omp critical
      errors += 1;
    }
    if (sizeof(rdct_or2) != sizeof(long)) {
      #pragma omp critical
      errors += 1;
    }
  }
  ...
  if (errors == 0) {
    printf ("reduction 015 : SUCCESS\n");
    return 0;
  } else {
    printf ("reduction 015 : FAILED\n");
    return 1;
  }
}
