 ...
 */
/* reduction 014 :
 * short 変数に reduction が指定された場合の動作確認
 */
...
short	rdct_inc, rdct_inc2, rdct_pls, rdct_pls2, rdct_pls3;
short	rdct_dec, rdct_dec2, rdct_mns, rdct_mns2;
short	rdct_mul, rdct_mul2, rdct_mul3;
short	rdct_land, rdct_land2, rdct_land3;
short	rdct_lor, rdct_lor2, rdct_lor3;
short	rdct_xor, rdct_xor2, rdct_xor3;
short	rdct_and, rdct_and2;
short	rdct_or, rdct_or2;

short	rst_inc, rst_inc2, rst_pls, rst_pls2, rst_pls3;
short	rst_dec, rst_dec2, rst_mns, rst_mns2;
short	rst_mul, rst_mul2, rst_mul3;
short	rst_land, rst_land2, rst_land3;
short	rst_lor, rst_lor2, rst_lor3;
short	rst_xor, rst_xor2, rst_xor3;
short	rst_and, rst_and2;
short	rst_or, rst_or2;
...
main ()
{
  ...
  for (i=0; i<LOOPNUM; i++) {
    ...
    if (sizeof(rdct_inc) != sizeof(short)) {
      #pragma omp critical
      errors += 1;
    }
    if (sizeof(rdct_inc2) != sizeof(short)) {
      #pragma omp critical
      errors += 1;
    }
    if (sizeof(rdct_pls) != sizeof(short)) {
      #pragma omp critical
      errors += 1;
    }
    if (sizeof(rdct_pls2) != sizeof(short)) {
      #pragma omp critical
      errors += 1;
    }
    if (sizeof(rdct_pls3) != sizeof(short)) {
      #pragma omp critical
      errors += 1;
    }
    if (sizeof(rdct_dec) != sizeof(short)) {
      #pragma omp critical
      errors += 1;
    }
    if (sizeof(rdct_dec2) != sizeof(short)) {
      #pragma omp critical
      errors += 1;
    }
    if (sizeof(rdct_mns) != sizeof(short)) {
      #pragma omp critical
      errors += 1;
    }
    if (sizeof(rdct_mns2) != sizeof(short)) {
      #pragma omp critical
      errors += 1;
    }
    if (sizeof(rdct_mul) != sizeof(short)) {
      #pragma omp critical
      errors += 1;
    }
    if (sizeof(rdct_mul2) != sizeof(short)) {
      #pragma omp critical
      errors += 1;
    }
    if (sizeof(rdct_mul3) != sizeof(short)) {
      #pragma omp critical
      errors += 1;
    }
    if (sizeof(rdct_land) != sizeof(short)) {
      #pragma omp critical
      errors += 1;
    }
    if (sizeof(rdct_land2) != sizeof(short)) {
      #pragma omp critical
      errors += 1;
    }
    if (sizeof(rdct_land3) != sizeof(short)) {
      #pragma omp critical
      errors += 1;
    }
    if (sizeof(rdct_lor) != sizeof(short)) {
      #pragma omp critical
      errors += 1;
    }
    if (sizeof(rdct_lor2) != sizeof(short)) {
      #pragma omp critical
      errors += 1;
    }
    if (sizeof(rdct_lor3) != sizeof(short)) {
      #pragma omp critical
      errors += 1;
    }
    if (sizeof(rdct_xor) != sizeof(short)) {
      #pragma omp critical
      errors += 1;
    }
    if (sizeof(rdct_xor2) != sizeof(short)) {
      #pragma omp critical
      errors += 1;
    }
    if (sizeof(rdct_xor3) != sizeof(short)) {
      #pragma omp critical
      errors += 1;
    }
    if (sizeof(rdct_and) != sizeof(short)) {
      #pragma omp critical
      errors += 1;
    }
    if (sizeof(rdct_and2) != sizeof(short)) {
      #pragma omp critical
      errors += 1;
    }
    if (sizeof(rdct_or) != sizeof(short)) {
      #pragma omp critical
      errors += 1;
    }
    if (sizeof(rdct_or2) != sizeof(short)) {
      #pragma omp critical
      errors += 1;
    }
  }
  ...
  if (errors == 0) {
    printf ("reduction 014 : SUCCESS\n");
    return 0;
  } else {
    printf ("reduction 014 : FAILED\n");
    return 1;
  }
}
